...
set -q PI_COMMAND_NOT_FOUND_SESSION_ID
and test -n "$PI_COMMAND_NOT_FOUND_SESSION_ID"
or set -gx PI_COMMAND_NOT_FOUND_SESSION_ID (command-not-found-agent session-id)
